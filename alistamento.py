...
if idade > 18:
    ...
    print(f"Você ainda não está na idade para se alistar. O alistamento obrigatório só acontece quando você completa 18 anos, espere mais {18-idade} anos para se alistar.")